...
<div class="container py-5">
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('perusahaan.lamaran.index') }}" method="GET">
                <div class="row g-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <select name="lowongan_id" class="form-select" aria-label="Filter by lowongan">
                            ...
                            @foreach(\App\Models\Lowongan::where('perusahaan_id', auth()->user()->perusahaan_id)->orderBy('judul')->get() as $lowongan)
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="{{ route('perusahaan.lamaran.show', $item->id) }}" class="btn btn-sm btn-info" title="Lihat">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('perusahaan.lamaran.edit', $item->id) }}" class="btn btn-sm btn-warning" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('perusahaan.lamaran.destroy', $item->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    @if($item->dokumen)
                                    <a href="{{ route('perusahaan.lamaran.download', $item->id) }}" class="btn btn-sm btn-secondary" title="Download Dokumen">
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="text-center text-muted">Tidak ada lamaran ditemukan.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
