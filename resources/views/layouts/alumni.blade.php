...
<style>
    :root {
        --sidebar-bg: white;
        /* Changed to white for sidebar background */
    ...
    .sidebar {
        ...
        /* Added border to distinguish from main content */
    }
    ...
    .stat-icon {
        ...
        /* Keep primary color for contrast */
        flex-shrink: 0;
    }
    ...
    .sidebar-toggle {
        background: none;
        color: #333;
        /* Changed to dark color for visibility */
        border: none;
...
<body>
    ...
    <nav class="top-navbar">
        <div class="navbar-content">
            <div class="navbar-left-section">
                <!-- Mobile Toggle Button -->
                <button x-show="!isDesktopSidebarCollapsed && window.innerWidth < 992" class="sidebar-toggle"
                    @click="isMobileSidebarOpen = !isMobileSidebarOpen">
                    <i class="fas fa-bars"></i>
                </button>
                <!-- Desktop Toggle Button -->
                <button x-show="window.innerWidth >= 992" class="desktop-toggle"
                    @click="isDesktopSidebarCollapsed = !isDesktopSidebarCollapsed; localStorage.setItem('sidebarCollapsed', isDesktopSidebarCollapsed)">
                    <i class="fas fa-bars"></i>
                </button>
    ...
    <aside class="mobile-sidebar" x-show="isMobileSidebarOpen" x-transition>
        ...
        <div class="sidebar-menu">
            <a href="/alumni/dashboard" class="nav-link {{ request()->is('alumni/dashboard') ? 'active' : '' }}">
                <i class="fas fa-users"></i>
                <span>Dashboard</span>
            </a>
            <a href="" class="nav-link {{ request()->routeIs('alumni.*') ? 'active' : '' }}">
                <i class="fas fa-users"></i>
                <span>Lowongan</span>
            </a>
            <a href="" class="nav-link {{ request()->routeIs('perusahaan.*') ? 'active' : '' }}">
