...
@section('content')
    ...
    <div class="hero">
        <img src="{{ asset('image/Pattern.png') }}" alt="" width="200"
            style=" margin-top: -10rem;left: 0; position: absolute;" class="pattern1">
        <img src="{{ asset('image/Pattern.png') }}" alt="" width="200"
                ...
                <div class="col-lg-6 text-center">
                    <div class="position-relative">
                        <img src="{{ asset('image/Rectangle 463.png') }}" class="img-fluid rounded shadow mb-3"
                            alt="Tim BKK">
                        {{-- Gambar tambahan --}}
                        <img src="{{ asset('image/logobkk.jpg') }}" class="position-absolute bottom-0 end-0 rounded shadow"
                            style="width: 120px;" alt="Rapat">
                ...
                @foreach ($lowongan->take(3) as $job)
                    <div class="job">
                        <div class="job-info2">
                            ...
                            <a href="{{ route('lowongan.show.public', $job->slug) }}"><button>Lihat</button></a>
                        </div>
                    </div>
                @endforeach
            </div>
        ...
        <div class="container">
            <div class="row align-items-center mb-4">
                <div class="col-md-6 mb-4 mb-md-0 ">
                    ...
                    <p>SMKN 6 Jember bekerja sama dengan berbagai perusahaan untuk memberikan siswa dan
                        alumni peluang magang, praktik kerja, dan kerja.
                        Temukan mitra yang sesuai minatmu.</p>
                            ...
                            <div class="card h-100 shadow-sm">
                                <div class="card-body text-center">
                                    <img src="{{ asset('image/mitra1.jpeg') }}" class="mb-2" alt="Logo"
                                        width="60"> <!-- logo sedikit lebih besar -->
                        ...
                        <article class="agenda-item">
                            ...
                            <div class="agenda-body">
                                ...
                                <div class="agenda-actions">
                                    <a href="{{ route('kegiatan.show.public', $item->id) }}" class="btn-primary">
                                        Lihat Detail
                                    </a>
                    ...
                    <article class="feature-card">
                        ...
                        <div class="feature-body">
                            ...
                            <p class="feature-meta">
                                {{ $featured->tipe_kegiatan ?? 'BKK SMKN 6 JEMBER' }}
                            </p>
                            <a href="{{ route('kegiatan.show.public', $featured->id) }}" class="btn-secondary">
                                Lihat Detail
                            </a>
                        </div>
                    </article>
